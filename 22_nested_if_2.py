...
'''
    ...
    3) if different is 0 then display message no profit no loss 
    otherwise
    4) if differnce is > 0 then display message profit with difference variable 
    5) if difference is < 0 then display message loss with difference variable 
'''
